...
<div class="page-inner">
	...
	<div class="row">
		...
		<div class="col-md-12 col-xs-12 mt-3">
			...
			$qry = mysqli_query($con, "SELECT MONTH(tgl_absen) AS month_absen, COUNT(*) AS total_absen
                           FROM _logabsensi
			...
			foreach ($qry as $bulan) { ?>
				<?php
				$bulan_absen = $bulan['tgl_absen'];
				$bulan = !empty($bulan_absen) ? date('m', strtotime($bulan_absen)) : '';
				?>
