...
<div class="page-inner">
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-xs-12">
            ...
            // Pastikan variabel $con sudah terkoneksi ke database sebelumnya.

            // Pastikan $_GET['pelajaran'] sudah difilter dan aman digunakan.
            $pelajaran = $_GET['pelajaran'];

            $last_pertemuan = mysqli_query($con, "SELECT MAX(pertemuan_ke) as max_pertemuan FROM _logabsensi WHERE id_mengajar = '$pelajaran'");
            $jml = mysqli_fetch_array($last_pertemuan);
            $pertemuan = $jml['max_pertemuan'] + 1;
